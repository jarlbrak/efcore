...
using Microsoft.EntityFrameworkCore.AzureTable.Internal;
...
/// </summary>
public class AzureTableTransactionManager : IDbContextTransactionManager, ITransactionEnlistmentManager
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    public virtual void EnlistTransaction(Transaction? transaction)
        => throw new NotSupportedException("Transactions are not supported by Azure Table Storage.");
